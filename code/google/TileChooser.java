...
public class TileChooser extends JPanel implements ActionListener,
	...
	class TileButton extends JToggleButton implements ActionListener,
		...
		public TileButton(Tile t) {
			...
			Image i2 = new BufferedImage(gfx.getBaseTileSize().width,
					gfx.getBaseTileSize().height, BufferedImage.TYPE_INT_ARGB);
		...
		public boolean importData(JComponent comp, Transferable t) {
			...
			try {
				...
				if (files.size() > 4) {
					 ...
					 * if(!(PromptDialog
					 * .ask("Really process "+files.size()+" files?", "Yes",
					 * "Cancel").equals("Yes"))) { return false; }
					 */
				}
				...
				System.err
						.println("Unexpected IO Exception while importing tile: "
								+ e);
				e.printStackTrace();
				// PromptDialog.tell("Sorry, something broke. Please save your work and restart the program.",
				// "OK");
			}
			return true;
		}
